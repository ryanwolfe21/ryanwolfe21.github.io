function calculateTip() {
  ...
  var serviceQuality = document.getElementById("satisfaction").value;
  ...
  document.querySelector("#totalTip #tip").innerHTML = total;
  updateLocalStorage(total);
}
...
function updateLocalStorage(totalTip) {
  window.localStorage.setItem("totalTip", totalTip);
}
...
function characterCount() {
  var textEntered, characterDisplay, counter;
...
if (window.localStorage) {
  ...
  if (localStorage.getItem("totalTip")) {
    document.getElementById("totalTip").style.display = "block";
    document.getElementById("each").style.display = "block";
    document.querySelector("#totalTip #tip").innerHTML = localStorage.getItem(
      "totalTip"
    );
  }

  totalBill.addEventListener(
    "input",
    function () {
